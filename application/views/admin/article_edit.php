...
<body>
  ...
  <nav class="application-nav">
    <div class="container">
      <ul>
        <li class=""><a href="<?=base_url()?>admin/logged_in"><span class="ion-home"></span><span class="text">Atricle List</span></a></li>
  ...
  <section id="main-content">
    <div class="container">
     ...
     <?= form_open_multipart('admin/update_article',['class'=>'article_form','id'=>'article_id']);?>
     	
     	<input type="hidden" name="article_id" value="<?php echo $edit_data[0]['id'];?>">

        <div class="span-12"><input type="file" name="userfile_edit"></div>

      <div class="span-6">
        <div class="panel">
          <label class="panel-header" for="page-title">
            Article Title
            <span class="hint">Enter your article title here</span>
          </label>
          <div class="panel-body">
            <input id="page-title" type="text"  name="article_title" value="<?php echo $edit_data[0]['article_name'];?>" />
          </div>
        </div>
      </div>
      ...
      <div class="span-6">
        <div class="panel">
          ...
          <div class="panel-body">
            <input id="page-url" type="text"  name="article_url" value="<?php echo $edit_data[0]['url'];?>" />
          </div>
        </div>
      </div>
      ...
      <div class="span-12">
        <div class="panel">
          ...
          <div class="panel-body">
            ...
            <textarea id="page-main-content" name="article_text"><?php echo $edit_data[0]['article_text'];?></textarea>
          </div>
        </div>
      </div>
